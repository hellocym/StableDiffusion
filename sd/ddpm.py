...
class DDPMSampler:
    ...
    def set_inference_timesteps(self, num_inference_steps=50):
        ...
        # 999, 998, 997, ..., 0 (num_inference_steps=1000)
        # 999, 999-20, 999-40, ..., 0 (num_inference_steps=50)
    ...
    def _get_variance_(self, t: int) -> torch.Tensor:
        ...
        varience = (1 - alpha_prod_t_prev) / (1 - alpha_prod_t) * current_beta_t
        varience = torch.clamp(varience, min=1e-20)
    ...
    def step(self, timestep: int, latents: torch.Tensor, model_output: torch.Tensor) -> torch.Tensor:
        ...
        if t > 0:
            ...
            varience = self._get_variance_(t) ** 0.5 * noise

        pred_prev_sample = pred_prev_sample + varience
